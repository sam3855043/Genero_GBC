  ...
  function(context, cls) {
    ...
    context.WebComponentService = context.oo.StaticClass(
      /** @lends gbc.WebComponentService */
      {
        ...
        /**
         * Api that will be bound to webcomponent
        ...
        _api: function() {
          return /** @ignore */ {
            ...
            // List all theme variables you want to use inside your webcomponent
            /** @ignore */
            useGbcThemeVariables: function(webcomponentWidget, variableArray) { // only with gICAPI v2
              webcomponentWidget.injectThemeVariables(variableArray);
            }
          };
        }
