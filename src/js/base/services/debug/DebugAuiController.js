    ...
    cls.DebugAuiController = context.oo.Class(function() {
      return /** @lends classes.DebugAuiController.prototype */ {
        ...
        refreshDebugAui: function(node) {
          ...
          document.getElementsByClassName('version-number')[0].innerHTML = gbcVersion;
          document.getElementsByClassName('build-number')[0].innerHTML = buildNumber;
          document.getElementsByClassName('fgl-version')[0].innerHTML = runtimeVersion;
          document.getElementsByClassName('gas-version')[0].innerHTML = serverVersion;
